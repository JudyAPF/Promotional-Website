            ...
            <div class="owl-carousel owl-theme">
                    ...
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-8 col-sm-12">
                                <h3>Puffy's Soufflé Pancake Café</h3>
                                <h1>{{ __('Our mission is to provide an unforgettable experience') }}</h1>
                                <a href="{{route('team')}}" class="section-btn btn btn-default smoothScroll">{{ __('Meet our chef') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item item-second">
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-8 col-sm-12">
                                <h3>{{ __('Your Perfect Breakfast') }}</h3>
                                <h1>{{ __('The best dinning quality can be here too!') }}</h1>
                                <a href="{{route('menu')}}" class="section-btn btn btn-default smoothScroll">{{ __('Discover menu') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item item-third">
                    <div class="caption">
                        <div class="container">
                            <div class="col-md-8 col-sm-12">
                                <h3>{{ __('New Restaurant in Town') }}</h3>
                                <h1>{{ __('Enjoy our special menus every Sunday and Friday') }}</h1>
                                <a href="{{route('contact')}}" class="section-btn btn btn-default smoothScroll">{{ __('Reservation') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
